...
MAIN_MODELS_PATH = os.environ.get("MAIN_MODELS_PATH", "/stable-diffusion-webui/models")
CONTROLNET_EXTENSION_PATH = os.environ.get(
    "CONTROLNET_EXTENSION_PATH",
...
CONTROLNET_ANNOTATORS_PATH = os.path.join(
    CONTROLNET_EXTENSION_PATH, "annotator/downloads/clip_vision"
)
...
class ModelDownloader:
    ...
    def __download_model_from_url__(self, model):
        ...
        if not os.path.exists(target_path):
            ...
            logger.info(
                f"{filename} already exists in the local directory, skipping download."
            )
...
models_to_download = [
    {
        "url": f"{MODELS_BASE_URL}/sd_xl_base_1.0.safetensors",
        "filename": "sd_xl_base_1.0.safetensors",
        "filepath": STABLE_DIFFUSION_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/sdxl_vae.safetensors",
        "filename": "sdxl_vae.safetensors",
        "filepath": VAE_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/diffusers_xl_canny_full.safetensors",
        "filename": "diffusers_xl_canny_full.safetensors",
        "filepath": CONTROLNET_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/ip-adapter-plus_sdxl_vit-h.safetensors",
        "filename": "ip-adapter-plus_sdxl_vit-h.safetensors",
        "filepath": CONTROLNET_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/clip_h.pth",
        "filename": "clip_h.pth",
        "filepath": CONTROLNET_ANNOTATORS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/ESRGAN_4x.pth",
        "filename": "ESRGAN_4x.pth",
        "filepath": ESRGAN_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/RealESRGAN_x4plus.pth",
        "filename": "RealESRGAN_x4plus.pth",
        "filepath": REALESRGAN_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/RealESRGAN_x2plus.pth",
        "filename": "RealESRGAN_x2plus.pth",
        "filepath": ESRGAN_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/codeformer-v0.1.0.pth",
        "filename": "codeformer-v0.1.0.pth",
        "filepath": CODEFORMER_MODELS_PATH,
    },
    {
        "url": f"{MODELS_BASE_URL}/model_base_caption_capfilt_large.pth",
