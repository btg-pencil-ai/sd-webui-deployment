...
class HuggingFaceModelDownloader():
    def __init__(self) -> None:
        ...
        models_to_download = [
            ...
            {'repo_id': 'stabilityai/stable-diffusion-xl-refiner-1.0', 'filename': 'sd_xl_refiner_1.0.safetensors', 'filepath': MAIN_MODELS_PATH},
            {'repo_id': 'stabilityai/sdxl-vae', 'filename': 'sdxl_vae.safetensors', 'filepath': MAIN_MODELS_PATH},
            {'repo_id': 'stabilityai/sd-vae-ft-mse-original', 'filename': 'vae-ft-mse-840000-ema-pruned.ckpt', 'filepath': MAIN_MODELS_PATH},
